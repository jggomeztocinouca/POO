...
public:
    ...
    void no_es_titular_de(const Tarjeta& card); // Método de deasociación de tarjetas

    ~Usuario(); // Destructor de usuarios

    void compra(const Articulo& a, size_t cantidad=1); // Método de asociación de articulos
